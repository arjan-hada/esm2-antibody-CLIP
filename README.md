...
🛠️ Implement ESM2-Ab-CLIP with larger ESM2 models. The implementation here is with the smallest model 'facebook/esm2_t6_8M_UR50D' due to GPU resources limitation.
